...
You can load the structure as a "cartoon", "ball+stick", "line", "surface", "ribbon", or any other representation listed in the [NGL.js](http://nglviewer.org/ngl/api/) manual under "StructureRepresentation". Multiple representations of the same structure can be overlaid by chaining the `addSelection()` function. Also see the "structure" tab in the [demo](https://www.nvelden.com/shiny/shiny_NGLVieweR/) app for a list of possible representations.  
...
NGLVieweR("3RY2") %>% 
  addRepresentation("cartoon") %>%
  addRepresentation("ball+stick", param = list(name = "biotin", 
                                               colorvalue = "grey", 
                                               colorScheme="element", 
                                               sele="5001")) %>%
  addRepresentation("ball+stick", param = list(name = "interacting", 
                                               colorvalue = "green", 
                                               colorScheme="element", 
                                               sele="23 or 27 or 43 or 45 or 128")) %>%
  addRepresentation("contact", param = list(name="contact",
...
```{r, echo=FALSE, out.width="50%"}
knitr::include_graphics("../man/figures/contact_representation.png")
```
